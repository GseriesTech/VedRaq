    ...
    <div className="relative min-h-screen bg-[#030303] text-zinc-100 overflow-x-hidden font-sans selection:bg-zinc-800 selection:text-white">
      ...
      <main className="relative z-10 mx-auto max-w-7xl px-6 pt-32 sm:px-8 sm:pt-40 md:pt-48 pb-24">
        ...
        <section className="flex flex-col items-center text-center">
          ...
          <div className="mt-16 w-full relative overflow-hidden py-8 select-none">
            <div className="marquee-gradient-overlay" />
            <div className="animate-marquee flex gap-24 items-center opacity-40 hover:opacity-80 transition-all duration-500">
              {/* Set 1 */}
              <div className="flex items-center gap-24 shrink-0">
                <div className="text-zinc-500 hover:text-zinc-200 transition-colors duration-300 select-none shrink-0">
                ...
                <div className="text-zinc-500 hover:text-zinc-200 transition-colors duration-300 select-none shrink-0">
                  <span className="h-8 w-8 bg-zinc-600 hover:bg-zinc-200 text-[#030303] flex items-center justify-center font-bold text-lg rounded-md select-none shrink-0 font-sans transition-colors duration-300 leading-none">N</span>
                </div>
                <div className="text-zinc-500 hover:text-zinc-200 transition-colors duration-300 select-none shrink-0">
                  <svg className="h-8 w-8 fill-current" viewBox="0 0 24 24">
                ...
                <div className="text-zinc-500 hover:text-zinc-200 transition-colors duration-300 select-none shrink-0">
                  <svg className="h-8 w-8 fill-current" viewBox="0 0 24 24">
                    <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.41 0-8-3.59-8-8 0-.29.02-.58.06-.86L9.42 16.5c.34.22.75.35 1.18.35h2.8c.43 0 .84-.13 1.18-.35l5.36-5.36c.04.28.06.57.06.86 0 4.41-3.59 8-8 8zm6.54-9.28l-4.71 4.71c-.13.07-.28.1-.43.1h-2.8c-.15 0-.3-.03-.43-.1L5.46 10.72c.48-2.69 2.58-4.8 5.28-5.28l4.76 4.76c.07.13.1.28.1.43v2.8c0 .15-.03.3-.1.43z"/>
                  </svg>
                </div>
                <div className="text-zinc-500 hover:text-zinc-200 transition-colors duration-300 select-none shrink-0">
                  <svg className="h-8 w-8 fill-current" viewBox="0 0 24 24">
